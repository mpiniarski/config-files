...
# Load plugins and theme and much more
...
# Uncomment the following line to use base16 colors in shell 
# (not working in may terminal emulators)
# source "$HOME/.base16/base16-shell/base16-default.dark.sh"
